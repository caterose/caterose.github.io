...
import styles from './gallery-standard.module.css';
...
export const GalleryStandard: React.FC<GalleryStandardProps> = ({
  title,
  job,
  images,
  nodes,
  link,
}: GalleryStandardProps) => {
  ...
  // Debug: log images
  console.log('ProjectStandard received images:', images);
  console.log('ProjectStandard images length:', images?.length || 0);
      ...
      <div className={styles.left}>
        {images && images.length > 0 ? (
          <div className={styles.projectImagesContainer}>
            <div
              ...
              onScroll={(e) => {
                ...
                const imageWidth = 350 + 12; // image width + gap
          ...
          <div style={{ padding: '20px', color: 'red', fontSize: '16px' }}>
            No images provided (images: {images ? 'empty array' : 'undefined'})
          </div>
        )}
      </div>
